...
// Full-screen Todo detail page. Mirrors the SettingsView shell — a TitledPanel
// fills the screen with structured sections; a key-hint Footer pins the bottom.
// Hosts the long-form description once the server returns it; falls back to a
// muted placeholder so the section is always present for layout consistency.
  ...
  return (
    <Box flexDirection="column" paddingX={1}>
      <TitledPanel title="Todo" width={panelWidth} height={panelHeight} paddingX={2} paddingY={1} focused>
        ...
        <Box marginTop={1}>
          <Box flexDirection="column" width={Math.floor((panelWidth - 8) / 2)}>
